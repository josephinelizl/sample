...
function init() { /* Basic options for a simple Google Map For more options see: https://developers.google.com/maps/documentation/javascript/reference#MapOptions */
    var mapOptions = { /* How zoomed in you want the map to start at (always required) */
        zoom: 15,
        disableDefaultUI: true,
        /*The latitude and longitude to center the map (always required) */ center: new google.maps.LatLng(41.9611785, -87.7100965),
        /* How you would like to style the map. This is where you would paste any style found on Snazzy Maps. */ styles: [{
...
$('.rowsections').lazyLoad();
$('.parallax2').lazyLoad();
$('.aboutparallax').lazyLoad();
$('.story-image').lazyLoad();
$('.menunavigation').lazyLoad();
$('.menuimages').lazyLoad();
$('.partynavigation').lazyLoad();
$('.playnavigation').lazyLoad();
$('.gallerynavigation').lazyLoad();